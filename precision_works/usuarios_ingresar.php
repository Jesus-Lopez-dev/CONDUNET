                ...
                <div class='container'>
                    <div class='card'>
                        <div class='card-header'>
                            <h1>Generar un nuevo usuario</h1>
                        </div>
                        <div class='card-body'>
                        <form action = "insertar_usuario.php" method="post" class="needs-validation" enctype="multipart/form-data" novalidate>
                            <div class="form-row">
                                ...
                                <div class="col-md-10 mb-4">
                                    ...
                                    <input type="text" class="form-control" name="password" placeholder="Ingrese una nueva contraseña" required>
                                ...
                                <div class="col-md-10 mb-4">
                                    ...
                                    <p><label for="validationCustom01"><br>* Campos obligatorios</label></p>
                                </div>
                            </div>
                        </div>                  
                </div>
